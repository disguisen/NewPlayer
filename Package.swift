...
// App target that wires the SwiftUI entry point and uses package modules.
package.targets.append(
    .executableTarget(
        name: "NewPlayerApp",
        dependencies: ["Library", "Player", "Common", "Core", "Networking"],
        path: "App",
        exclude: ["Resources/Info.plist", "Preview Content"],
        resources: [
